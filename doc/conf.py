...
project = u'Software Foundations in Lean'
...
html_theme_options = {
    ...
    'code_bg': 'white',
    'extra_nav_links': {'PDF version':'software_foundations_in_lean.pdf',
...
htmlhelp_basename = 'software_foundations_in_lean'
...
latex_documents = [
    (master_doc, 'software_foundations_in_lean.tex', u'Software Foundations in Lean',
...
man_pages = [
    (master_doc, 'software_foundations_in_lean', u'Software Foundations in Lean',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'software_foundations_in_lean', u'Software Foundations in Lean',
     author, 'software_foundations_in_lean', 'A tutorial introduction to Lean',
     'Miscellaneous'),
]
